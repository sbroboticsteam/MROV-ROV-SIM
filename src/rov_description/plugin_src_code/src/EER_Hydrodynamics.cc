      ...
      gz::sim::EntityComponentManager &_ecm)
{
  ...
  // Hi zaid
  // I am well into figuring out this plugin. Here are two things to do
  // 1. Fix the bug where we crash due to a large value of ZdotW
  // 2. Write my darn website algorithm idea and what I've discovered so far
  // 3. Finish my darn website
...
GZ_ADD_PLUGIN_ALIAS(
  Hydrodynamics,
  "gz::sim::systems::EER_Hydrodynamics")